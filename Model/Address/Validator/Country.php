...
class Country implements ValidatorInterface
{
    ...
    public function validate(AbstractAddress $address)
    {
        ...
        if (empty($errors)) {
            if (isset($this->helper->getConfigFields()['region_id']) && $this->helper->getConfigFields()['region_id'] == '0') {
    ...
    private function validateCountry(AbstractAddress $address)
    {
        ...
        $errors = [];
        if (isset($this->helper->getConfigFields()['country_id']) && $this->helper->getConfigFields()['country_id'] == '0') {
